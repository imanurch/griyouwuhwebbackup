...
//get data tracking
$trackingData = getTrackingOrganik();

//update data tracking
if (isset($_POST['updateTracking'])) {
  $tahap1 = updateTrackingOrganik("terkumpul di tps", $_POST['ton1'], $_POST['kg1'], $_POST['ons1'], $_POST['gram1']);
  if ($tahap1) {
    $tahap2 = updateTrackingOrganik("proses pengolahan", $_POST['ton2'], $_POST['kg2'], $_POST['ons2'], $_POST['gram2']);
    if ($tahap2) {
      $tahap3 = updateTrackingOrganik("produk terjual", $_POST['ton3'], $_POST['kg3'], $_POST['ons3'], $_POST['gram3']);
      if ($tahap3) {
        echo "<script>alert('Tracking Sampah Organik berhasil diperbaharui!')</script>";
        header('refresh:0; url=organik');
      } else {
        echo "<script>alert('Tracking Sampah Organik Tahap 'Olahan terjual' gagal. Mohon ulangi.')</script>";
        header('refresh:0; url=organik');
      }
    } else {
      echo "<script>alert('Tracking Sampah Organik Tahap 'Proses Pengolahan' gagal. Mohon ulangi.')</script>";
      header('refresh:0; url=organik');
    }
  } else {
    echo "<script>alert('Tracking Sampah Organik Tahap 'Terkumpul di TPS' gagal. Mohon ulangi.')</script>";
    header('refresh:0; url=organik');
  }
}
...
<head>
  <meta charset="utf-8" />
  <title>Tracking Organik | Griyo Uwuh</title>
  <meta name="viewport" content="width=device-width, initial-scale=1.0" />
  <meta content="Tracking pengelolaan sampah organik di TPS Griyo Uwuh" name="description" />
          ...
          <div class="page-title-box align-self-center d-none d-sm-block">
            <nav aria-label="breadcrumb" class="pt-3">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page">Sampah Organik</li>
              </ol>
            </nav>
          </div>
          <!-- end page title -->
      ...
      <div class="page-content">
        <div class="container-fluid container-tracking">
          ...
          <div>
            ...
            <button class="mb-0 btn-track" data-bs-toggle="modal" data-bs-target="#modalinput">Tambah Bobot Sampah Organik</button>
              ...
              <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                <div class="modal-content text-fontdark">
                  <div class="modal-header" style="border-color: #c9e7af; padding: 17px 33px">
                    <h5 class="modal-title display-subheading fw-semibold" id="modalinputLabel">Tambah Bobot Sampah Organik</h5>
                  ...
                  <div class="modal-body justify-content-center" style="padding: 29px 33px">
                    <div>
                      <form action="" method="POST">
                        ...
                        <div class="align-items-center" style="padding-bottom: 25px">
                          <label for="" class="display-subheading" style="margin-right: 20px">Proses Pengolahan</label>
                          <div class="flexmodal justify-content-around pt-2">
                            <div class="flexmodal1">
                              <div class="d-flex align-items-center">
          ...
          <div class="y-gap-layout">
            <div class="card card-4 centerbox" style="margin-bottom: 14px">
            ...
            <div class="card card-4" style="margin-bottom: 14px">
              <div class="card-body bcard-4">
                <div>
                  <div class="order-track">
                    <div class="">
                      <img src="../assets/pic/olah.png" alt="" class="imgr" />
                    </div>

                    <div class="gap-track">
                      <p class="mb-0 fw-bolder fontr">Proses Pengolahan</p>
                      <div class="flexr-2 align-items-center">
                        <div class="flexr">
                          <div class="d-flex align-items-center">
