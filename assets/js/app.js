!(function () {
  ...
  (window.onload = function () {
    ...
    (function () {
      ...
      window.onload = function () {
        1024 <= window.innerWidth && window.innerWidth <= 1366 && (document.body.setAttribute("data-sidebar-size", "lg"), m("sidebar-size-large"));
      };
            ...
            (e = t.parentElement) &&
              ...
              (a = e.parentElement) &&
                ...
                (s = a.parentElement) &&
                  ...
                  (n = s.parentElement) && "side-menu" !== n.id && (n.classList.add("mm-show"), (o = n.parentElement) && "side-menu" !== o.id && o.classList.add("mm-active"))))));
        });
    }, 0),
