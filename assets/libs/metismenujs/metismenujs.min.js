...
!(function (t, e) {
  ...
  return (
      ...
      this.element.classList.add(t),
        [].slice.call(this.element.querySelectorAll(this.config.subMenu)).forEach(function (t) {
          ...
          "true" !== (null == i ? void 0 : i.getAttribute("aria-disabled")) &&
            (null != i && i.setAttribute("aria-expanded", "false"), null != i && i.addEventListener("click", n.clickEvent.bind(n)), n.triggerArr.push(i));
        });
    }),
    (s.prototype.clickEvent = function (t) {
      var e, i, n;
      this.disposed ||
        ((e = null == t ? void 0 : t.currentTarget) && "A" === e.tagName && t.preventDefault(),
        (n = null == (i = y(e, this.config.parentTrigger)) ? void 0 : i.querySelector(this.config.subMenu)),
        this.toggle(n));
    }),
    ...
    (s.prototype.emit = function (t, e, i) {
      ...
      return (
        void 0 === i && (i = !1),
        "function" == typeof CustomEvent ? (n = new CustomEvent(t, { bubbles: i, detail: e })) : (n = document.createEvent("CustomEvent")).initCustomEvent(t, i, !1, e),
